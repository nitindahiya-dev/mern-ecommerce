...
export default function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.email && !formData.password) return setErrorMessage("Please fill all the fields.👨‍💻")
    try {
      setLoading(true);
          ...
          <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
            ...
            <div className="flex flex-col max-w-md sm:w-[500px]  space-y-5">
              <form onSubmit={handleSubmit}>
                ...
                <button className="flex w-full mt-4 items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black relative">
