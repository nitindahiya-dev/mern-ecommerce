          ...
          <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
            ...
            <div className="flex flex-col max-w-md sm:w-[500px]  space-y-5">
              ...
              <input type="password" placeholder="Your Password"
                className="flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" />
              <button className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Submit Now</button>
