      ...
      <div className="mx-auto w-full max-w-[1450px] p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="/about-us" className="hover:underline">New Arrivals</a>
                </li>
                <li>
                  <a href="https://tailwindcss.com/" className="hover:underline">Men</a>
                </li>
                <li className="mt-4 mb-4">
                  <a href="/about-us" className="hover:underline">Women</a>
                </li>
                <li>
                  <a href="https://tailwindcss.com/" className="hover:underline">Shop All</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a href="https://github.com/nitindahiya199" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
